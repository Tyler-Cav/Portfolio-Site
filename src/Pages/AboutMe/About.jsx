          ...
          <Item>
            <Grid style={{ display: 'flex', justifyContent: 'space-between' }} container spacing={0}>
              <Grid item xs={12}>
                ...
                <Item style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", textAlign: "center", flexWrap: "wrap" }}>
                  <h1 style={{ color: "white", whiteSpace: "pre-wrap", fontSize: "50px", padding: " 0 50px 0 50px" }}>
                    <span style={{ fontSize: "70px" }}>
                      Nice to meet you!</span> I'm Tyler
                  </h1>
                </Item>
              </Grid>
